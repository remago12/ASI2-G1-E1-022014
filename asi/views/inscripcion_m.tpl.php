...
<body>
	...
	<hr class="line">
		<div class="col-lg-6"><br><br>
			...
			<input type="text"  name="nombre" id="segundoNombre" placeholder="Segundo Nombre" class="validate[required] medium form-control" title="Sólo texto" pattern="[A-Za-z]{3,30}" maxlength="30"><br>
			...
			<input type="text" name="apellido" id="segundoApellido" placeholder="Segundo Apellido" class="validate[required] medium form-control" title="Sólo texto" autofocus pattern="[A-Za-z]{3,30}" maxlength="30"><br>
		...
		<input type="text"  name="telcasa" id="telcasa" placeholder="Teléfono de casa" class="validate[required] medium form-control" pattern="[0-9]{8}" maxlength="8"><br>
