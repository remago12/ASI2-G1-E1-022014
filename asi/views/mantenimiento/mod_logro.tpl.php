  ...
  <body>
    ...
    <div class="container">
      ...
      <select id="estilo_select" name="idReqLogro" class="form-control">
          ...
          <?php 
      try{
      $cuadro = $cuadroC->seleccionar_logroM();
      }catch(Exception $e){
        echo "Ha ocurrido un error";
      }
      if($cuadro!=null)
        ...
        <a href="mod_logro.php?id=<?=base64_encode($idLogro)?>"><?=$nomLogro?> 
        </td>
        <td>
           <a href="mod_logro.php?id=<?=base64_encode($idLogro)?>"><?=$nomReqLogro?></a>
        </td>
        <td>
