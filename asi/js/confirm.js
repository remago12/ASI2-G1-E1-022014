...
function confirmacion(confirma) {
    if (confirm("Esta seguro que desea ir a Mantenimiento de "+ confirma ) == true) {
        if (confirma === 'banco') {
        	...
        	document.location.href= "http://localhost/asi2/ASI2-G1-E1-022014/asi/mantenimiento/alergias.html"
        }else if (confirma == 'estado'){
        	document.location.href = "http://localhost/asi2/ASI2-G1-E1-022014/asi/mantenimiento/estado.html"	
        }
